...
$ultimo_r = "SELECT MAX(mes) FROM consumoagua.lecturas";
$u_reg = mysqli_query($conexion, $ultimo_r);
$ult_reg = mysqli_fetch_assoc($u_reg);
$regis_ulti = ($ult_reg["MAX(mes)"]);
$row = "";


/*Consulta de mes anterior y siguiente */
...
<body>
		...
		<table class="tabla">
			...
			while ($row = mysqli_fetch_assoc($consulta)) {  ?>
				<tr>
					...
					<td><?php
						if ($row["MES"] == $regis_ulti) {?>
							<a href="Fotos/luctus/<?php echo $row["PICS"]; ?>">📷</a>
						<?php
						} else { 
							echo "";
						} ?>
	...
	<footer>Aguascalientes, Mexico, &copy;2019 - 2022</footer>
</body>
